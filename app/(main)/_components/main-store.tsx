        ...
        <div className="w-full py-10 bg-slate-100">                
            <div className="md:max-w-screen-2xl mx-auto">
                <div className="flex justify-between px-4">
                    <h1 className="text-xl md:text-xl text-start text-neutral-800 font-extrabold">샵</h1>
                    <Link href='/map'>전체보기</Link>
                </div>

                <div className="p-4 rounded-lg md:p-2 " id="stats" role="tabpanel" aria-labelledby="stats-tab">
